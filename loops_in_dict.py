...
for school_class in school:
    ...
    for name in school_class['students']:
        if is_male[name['first_name']]:
            ...
            female += 1
    # school_class['female'] = female
    # school_class['male'] = male
    class_name = school_class['class']
    print(f'В классе {class_name} {female} девочки и {male} мальчика.')
...
for school_class in school:
    ...
    # school_class['male'] = male
    if female > male:
        f_class = school_class['class']
    else:
        m_class = school_class['class']
print(f'Больше всего мальчиков в классе {m_class}')
print(f'Больше всего девочек в классе {f_class}')
